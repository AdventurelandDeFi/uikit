...
var Icon$N = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 32 32" }, props),
        React.createElement("image", { width: "32", height: "32", href: "/images/adventureland/logo.png" })));
};
...
var Icon$I = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 90 90" }, props),
        React.createElement("image", { width: 90, height: 90, href: "/images/adventureland/token-pp.png" })));
};
...
var SpinnerIcon = function (props) {
    ...
    return (React.createElement(Svg, __assign({ viewBox: "0 0 96 96" }, props),
        React.createElement("image", { width: "96", height: "96", href: "/images/adventureland/d20" + (theme.isDark ? "-invert" : "") + ".png" })));
};
...
var Logo$1 = function (_a) {
    ...
    return (React.createElement(Svg, __assign({ viewBox: "0 0 205 26" }, props),
        React.createElement("image", { width: "205", height: "26", href: isDark ? "/images/adventureland/SideLogo_Dark.png" : "/images/adventureland/SideLogo_Light.png" })));
};
...
var Icon$a = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 213.563 213.563", useStroke: true, strokeWidth: 4 }, props),
        React.createElement("path", { d: "M106.782 213.563c-.774 0-1.549-.18-2.259-.539-1.767-.896-43.521-22.334-65.278-58.595-21.583-35.971-25.604-71.428-25.765-72.92a5 5 0 013.223-5.22c.134-.051 15.014-5.869 15.014-18.489 0-1.935-.294-4.443-1.693-5.406-1.997-1.375-6.417-.403-8.127.253a5.024 5.024 0 01-4.632-.546 5.005 5.005 0 01-2.177-4.115V17.724a5 5 0 017.034-4.567c1.891.822 6.622 2.048 9.039.525 2.25-1.412 2.476-6.037 2.232-8.056a5.032 5.032 0 011.221-3.93A5.006 5.006 0 0138.352 0H175.21a5 5 0 014.957 5.652c-.24 1.992-.015 6.617 2.234 8.029 2.42 1.52 7.148.296 9.06-.534a5.016 5.016 0 014.745.4 5 5 0 012.269 4.176v30.262a5.002 5.002 0 01-6.831 4.653c-1.689-.646-6.11-1.618-8.106-.245-1.399.963-1.693 3.473-1.693 5.407 0 12.62 14.879 18.438 15.03 18.495a5.022 5.022 0 013.207 5.214c-.161 1.492-4.182 36.949-25.765 72.92-21.756 36.261-63.511 57.699-65.277 58.595a5 5 0 01-2.258.539zM23.926 83.927c1.564 9.621 7.271 37.653 23.894 65.357 17.48 29.133 50.111 48.67 58.962 53.598 8.85-4.927 41.481-24.465 58.961-53.598 16.666-27.776 22.344-55.746 23.897-65.355-6.173-3.284-17.793-11.42-17.793-26.129 0-7.886 3.303-11.791 6.074-13.679 3.337-2.273 7.268-2.629 10.556-2.343V24.217c-3.48.453-7.7.252-11.392-2.066-4.811-3.021-6.389-8.151-6.837-12.15H43.315c-.448 3.999-2.026 9.13-6.837 12.15-3.691 2.318-7.912 2.523-11.392 2.066v17.562c3.288-.286 7.219.069 10.557 2.343 2.771 1.888 6.074 5.793 6.074 13.679 0 14.706-11.617 22.841-17.791 26.126zm33.692 61.137c-3.339 0-6.478-1.3-8.839-3.661a12.414 12.414 0 01-3.661-8.838c0-3.34 1.3-6.479 3.662-8.84l17.029-17.028-6.715-6.716a5 5 0 117.071-7.07l5.566 5.565 15.051-15.051-15.974-15.973a96.057 96.057 0 01-20.054-29.3l-3.26-7.398a5 5 0 016.592-6.591l7.398 3.26a96.017 96.017 0 0129.299 20.054l15.974 15.974 15.974-15.974a96.017 96.017 0 0129.299-20.054l7.398-3.26a5 5 0 016.592 6.591l-3.26 7.398a96.032 96.032 0 01-20.054 29.3l-15.973 15.974L141.906 98.6l5.688-5.688a5 5 0 117.071 7.07l-6.715 6.716 17.03 17.029a12.415 12.415 0 013.661 8.839c0 3.339-1.3 6.478-3.662 8.839-4.874 4.873-12.803 4.873-17.677 0l-17.03-17.03-6.715 6.715a5 5 0 11-7.071-7.07l5.443-5.443-15.173-15.174-15.051 15.051 5.566 5.566a5 5 0 11-7.071 7.07l-6.715-6.715-17.03 17.029a12.409 12.409 0 01-8.837 3.66zm15.262-31.295l-17.029 17.028a2.493 2.493 0 00-.732 1.769 2.501 2.501 0 004.268 1.768l17.029-17.029-3.536-3.536zm64.465 3.535l17.029 17.029a2.502 2.502 0 004.267-1.768 2.49 2.49 0 00-.732-1.768v-.001l-17.029-17.028-3.535 3.536zm-54.65-7.863l1.94 1.939 15.051-15.05-5.834-5.833-15.05 15.051 3.893 3.893zm28.52-15.723l17.664 17.663 5.833-5.833-51-51.001a86.026 86.026 0 00-21.574-15.74 86.046 86.046 0 0015.741 21.575l18.583 18.583c.375.215.728.483 1.048.804l12.905 12.904c.315.313.583.666.8 1.045zm2.736-23.32l5.834 5.834 15.851-15.852a86.012 86.012 0 0015.741-21.574 86.026 86.026 0 00-21.574 15.74l-15.852 15.852z" })));
};
...
var Icon$8 = function (props) {
    ...
    // viewBox="0 0 41.434 50.773"
    , __assign({ 
        // viewBox="0 0 41.434 50.773"
        viewBox: "0 0 50 50", useStroke: true }, props),
        React.createElement("path", { style: {
                textIndent: 0,
                textAlign: "start",
                lineHeight: "normal",
                textTransform: "none",
            }, d: "M16 5c-2.75 0-5 2.25-5 5v12a1 1 0 00.688.938l.187.062-.188.063A1 1 0 0011 24v12H6a1 1 0 00-.094 0A1 1 0 005 37v3c0 2.75 2.25 5 5 5h22c2.75 0 5-2.25 5-5v-5a1 1 0 00-.75-.969L36.125 34l.125-.031A1 1 0 0037 33V23a1 1 0 00-.281-.719L36.437 22l.282-.281A1 1 0 0037 21v-1a1 1 0 00-.688-.938L36.126 19l.188-.063A1 1 0 0037 18v-4h7a1 1 0 001-1v-3c0-2.696-2.167-4.915-4.844-5h-.031A1 1 0 0040 5H16zm0 2h20.125C35.468 7.846 35 8.852 35 10v2.813a1 1 0 000 .406v4.062l-2.313.782a1 1 0 000 1.875l2.188.75-.594.593a1 1 0 000 1.438l.719.718v8.782l-3.25.812a1 1 0 000 1.938l3.25.812V40c0 1.668-1.332 3-3 3s-3-1.332-3-3v-3a1 1 0 00-1-1H13V24.719l2.313-.782a1 1 0 000-1.875L13 21.282V10c0-1.668 1.332-3 3-3zm23.844 0A1.001 1.001 0 0040 7a1 1 0 00.094 0A2.989 2.989 0 0143 10v2h-6v-2a2.993 2.993 0 012.844-3zm-21.125 9A1.004 1.004 0 0019 18h10a1 1 0 100-2H19a1 1 0 00-.094 0 1.001 1.001 0 00-.093 0 1.004 1.004 0 00-.094 0zm0 4A1.004 1.004 0 0019 22h6a1 1 0 100-2h-6a1 1 0 00-.094 0 1.001 1.001 0 00-.093 0 1.004 1.004 0 00-.094 0zm0 4A1.004 1.004 0 0019 26h10a1 1 0 100-2H19a1 1 0 00-.094 0 1.001 1.001 0 00-.093 0 1.004 1.004 0 00-.094 0zm0 4A1.004 1.004 0 0019 30h6a1 1 0 100-2h-6a1 1 0 00-.094 0 1.001 1.001 0 00-.093 0 1.004 1.004 0 00-.094 0zM7 38h20v2c0 1.148.468 2.154 1.125 3H10c-1.668 0-3-1.332-3-3v-2z" })));
};

var Icon$7 = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 500 500", useStroke: true }, props),
        React.createElement("path", { d: "M349.223 319.162l-90.4-90.4c3.149-5.557 2.373-12.753-2.358-17.483l-.346-.346 46.805-46.805a9.144 9.144 0 002.49-8.37 9.086 9.086 0 00-5.607-6.624c-2.667-1.04-5.733-1.567-9.113-1.567-15.996 0-40.222 12.078-65.438 32.503l-1.968-1.968a14.468 14.468 0 00-10.3-4.263c-2.565 0-5.02.668-7.187 1.902l-.514-.514c-3.799-3.8-8.85-5.891-14.222-5.891a19.978 19.978 0 00-14.223 5.89 19.98 19.98 0 00-5.89 14.223 19.98 19.98 0 005.89 14.223l.518.517c-3.15 5.557-2.373 12.753 2.358 17.484l1.97 1.97c-20.134 24.912-37.994 56.447-30.938 74.548 1.374 3.525 4.717 5.802 8.517 5.802a9.1 9.1 0 006.476-2.685l46.805-46.805.346.346a14.47 14.47 0 0010.3 4.263c2.564 0 5.019-.668 7.186-1.902l90.396 90.396c3.799 3.8 8.85 5.89 14.222 5.89a19.982 19.982 0 0014.223-5.89c7.844-7.841 7.844-20.6.002-28.444zm-126.028-71.14c-.931 0-1.805-.36-2.458-1.014l-8.188-8.19-52.183 52.184c-.556-5.47 1.439-13.56 5.722-22.91 5.757-12.567 15.206-26.827 27.327-41.238l3.276-3.894-9.13-9.13a3.482 3.482 0 010-4.918l22.968-22.969a3.453 3.453 0 012.46-1.015c.93 0 1.804.36 2.458 1.015l9.13 9.13 3.893-3.274c24.304-20.442 48.147-33.142 62.225-33.142.674 0 1.315.03 1.921.093l-52.181 52.182 8.188 8.188a3.482 3.482 0 010 4.918l-22.969 22.969a3.453 3.453 0 01-2.459 1.015zm-40.782-61.141a8.98 8.98 0 012.27-3.812 8.982 8.982 0 016.38-2.643c.866 0 1.731.124 2.568.371a8.963 8.963 0 013.811 2.272l.137.136-12.76 12.761-.137-.137a8.984 8.984 0 01-2.643-6.379 9.175 9.175 0 01.374-2.57zm161.568 147.37a8.992 8.992 0 01-2.6 5.515 8.992 8.992 0 01-6.382 2.643 8.994 8.994 0 01-6.38-2.643l-90.02-90.02 12.761-12.76 18.052 18.051 71.967 71.968a8.992 8.992 0 012.601 5.516 9.098 9.098 0 01.001 1.73z", strokeWidth: 3.831, transform: "matrix(2.08815 0 0 2.08809 -276.51 -273.133)" })));
};
...
var socials = [
    {
        label: "Discord",
        icon: "DiscordIcon",
        href: "https://discord.gg/KePXbU4TBw",
    },
    {
        label: "Telegram",
        icon: "TelegramIcon",
        items: [
            ...
            {
                label: "Announcements",
                href: "https://t.me/AdventurelandFinanceAnnouncement",
            },
            // {
            //   label: "Whale Alert",
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#eeeeee", backgroundDisabled: "#a7a6a6", contrast: "#191326", invertedContrast: "#FFFFFF", input: "#EBEAE8", tertiary: "#EFF4F5", text: "#67595E", textDisabled: "#BDC2C4", textSubtle: "#988686", borderColor: "#E9EAEB", card: "#FFFFFF", gradients: {
